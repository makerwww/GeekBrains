...
const game = {
  ...
  status,
  tickInterval: null,
  gameScore: 0,  //Переменная для подсчета очков игры
  ...
  getRandomFreeCoordinates() {
    ...
    while (true) {
        this.gameScore += 1; // Добавление 1 к переменной при каждом ходе
        document.getElementsByTagName('h2')[0].innerText = `Score: ${this.gameScore - 1}`; // вывод хода в document
  ...
  newGameClickHandler() {
    this.gameScore = 0; //Обнуление очков при нажатии новой игры
    this.reset();
  },
